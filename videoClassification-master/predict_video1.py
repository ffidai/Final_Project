...
#	print('Old threshold = ', th)
	...
	cv2.putText(output, text, (35, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 5)
	...
	if writer is None:
		...
		#writer = cv2.VideoWriter( "output/"+ args["input"].split('.')[0] + "_" + args["model"] + "_output.MOV", fourcc, 30, (W, H), True)
		print("outfile = ",  "output/"+ args["input"].split('.')[0] + "_" + args["model"] + "_output.MOV")
